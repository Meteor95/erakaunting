...
<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="logo-wrapper"> <a href="index.html"><img class="img-fluid for-light" src="{{ asset('template/riho/images/logo/logo_dark.png') }}" alt="logo-light"><img class="img-fluid for-dark" src="{{ asset('template/riho/images/logo/logo.png') }}" alt="logo-dark"></a></div>
        <div class="toggle-sidebar"> <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
        </div>
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
        <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
            <div class="d-flex align-items-center gap-2 ">
            <h4 class="f-w-600">Welcome Alex</h4><img class="mt-0" src="{{ asset('template/riho/images/hand.gif') }}" alt="hand-gif">
            </div>
        </div>
        ...
        <ul class="nav-menus"> 
            ...
            <div class="form search-form mb-0">
                <div class="input-group"><span class="input-icon">
                    <svg>
                    <use href="{{ asset('template/riho/svg/icon-sprite.svg#search-header') }}"></use>
                    </svg>
            ...
            <svg>
                <use href="{{ asset('template/riho/svg/icon-sprite.svg#star')}}"></use>
            </svg>
            ...
            <div class="notification-box"> 
                <svg> 
                <use href="{{ asset('template/riho/svg/icon-sprite.svg#notification-header')}}"></use>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="user-message"> 
                            ...
                            <ul>
                                ...
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('template/riho/images/other-images/receiver-img.jpg')}}" alt="">
                            ...
                            <ul> 
                            <li>
                                <div class="user-alerts"><img class="user-image rounded-circle img-fluid me-2" src="{{ asset('template/riho/images/dashboard/user/5.jpg')}}" alt="user"/>
                                <div class="user-name">
                                    <div> 
                                    ...
                                    <div> 
                                    <svg>
                                        <use href="{{ asset('template/riho/svg/icon-sprite.svg#more-vertical')}}"></use>
                                    </svg>
                                    </div>
                                </div>
                                </div>
                            ...
                            <li>
                                <div class="user-alerts"><img class="user-image rounded-circle img-fluid me-2" src="{{ asset('template/riho/images/dashboard/user/6.jpg')}}" alt="user"/>
                                <div class="user-name">
                                    <div> 
                        ...
                        <div class="notification-card"> 
                            ...
                            <li class="notification d-flex w-100 justify-content-between align-items-center">
                                ...
                                <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{ asset('template/riho/images/dashboard/user/3.jpg')}}" alt="user"/></div>
                            ...
                            <li class="notification d-flex w-100 justify-content-between align-items-center">
                                <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{ asset('template/riho/images/dashboard/user/7.jpg')}}" alt="user"/></div>
                                <div class="flex-grow-1">
                                    <div class="common-space user-id w-100">
                            ...
                            <li class="notification d-flex w-100 justify-content-between align-items-center">
                                <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{ asset('template/riho/images/dashboard/user/5.jpg')}}" alt="user"/></div>
                                <div class="flex-grow-1">
                                    <div class="common-space user-id w-100">
                                    <div class="common-space w-100"> <a class="f-w-500 f-12" href="javascript:void(0)">Raye T. Sipes</a></div>
                                    </div>
                            ...
                            <li class="notification d-flex w-100 justify-content-between align-items-center">
                                <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                <div class="user-alerts flex-shrink-0"><img class="rounded-circle img-fluid img-40" src="{{ asset('template/riho/images/dashboard/user/6.jpg')}}" alt="user"/></div>
                                <div class="flex-grow-1">
                                    <div class="common-space user-id w-100">
                                    <div class="common-space w-100"> <a class="f-w-500 f-12" href="javascript:void(0)">Henry S. Miller</a></div>
                                    </div>
                        ...
                        <div class="cart-dropdown mt-4"> 
                            ...
                            <li class="pr-0 pl-0 pb-3">
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('template/riho/images/other-images/cart-img.jpg')}}" alt="">
                                <div class="media-body"><a class="f-light f-w-500" href="javascript:void(0)">Furniture Chair for Home</a>
                                    <div class="qty-box">
                                    <div class="input-group"> <span class="input-group-prepend">
                                        <button class="btn quantity-left-minus" type="button" data-type="minus" data-field="">-</button></span>
                                        <input class="form-control input-number" type="text" name="quantity" value="1"><span class="input-group-prepend">
                            ...
                            <li class="pr-0 pl-0 pb-3 pt-3">
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('template/riho/images/other-images/receiver-img.jpg')}}" alt="">
                                <div class="media-body"><a class="f-light f-w-500" href="javascript:void(0)">Men Cotton Blend Blue T-Shirt</a>
                                    <div class="qty-box"> 
                                    <div class="input-group"> <span class="input-group-prepend">
                                        <button class="btn quantity-left-minus" type="button" data-type="minus" data-field="">- </button></span>
                                        <input class="form-control input-number" type="text" name="quantity" value="1"><span class="input-group-prepend">
                            ...
                            <li class="mb-3 total"><a href="javascript:void(0)">
                                <h6 class="mb-0">
            ...
            <div class="media profile-media"><img class="b-r-10" src="{{ asset('template/riho/images/dashboard/profile.png')}}" alt="">
